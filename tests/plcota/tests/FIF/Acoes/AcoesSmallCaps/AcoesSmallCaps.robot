*** Settings ***
Documentation       Essa automação valida a variação de rentabilidade do tipo anbima: ações small caps
...
*** Test Cases ***
[PL/Cota] Envio de informe inicial do tipo ações small caps
    [Tags]    informe    acoessmallcaps    inicial
    ...
    ...    COD_SCLASSE=C0000025127    
    ...    COTA=135,322991    
    ...    PATRIMONIO=333341126,76        
    Validar-Processamento.Validar processamento do informe inicial

[PL/Cota] Envio de informe validando o limite superior externo da rentabilidade do tipo ações small caps
    [Tags]    informe    acoessmallcaps    superiorexterno
    Login.Acessar o HUB    ${EMAIL}
    Commons.Acessar o PLCota
    Commons.Iniciar cadastro manual
...
[PL/Cota] Envio de informe validando o limite superior interno da rentabilidade do tipo ações small caps
    [Tags]    informe    acoessmallcaps    superiorinterno
    Login.Acessar o HUB    ${EMAIL}
    Commons.Acessar o PLCota
    Commons.Iniciar cadastro manual
...
[PL/Cota] Envio de informe validando o limite inferior interno da rentabilidade do tipo ações small caps
    [Tags]    informe    acoessmallcaps    inferiorinterno
    Login.Acessar o HUB    ${EMAIL}
    Commons.Acessar o PLCota
    Commons.Iniciar cadastro manual
...
[PL/Cota] Envio de informe validando o limite inferior externo da rentabilidade do tipo ações small caps
    [Tags]    informe    acoessmallcaps    inferiorexterno
    Login.Acessar o HUB    ${EMAIL}
    Commons.Acessar o PLCota
    Commons.Iniciar cadastro manual
...
[PL/Cota] Envio de informe validando o limite médio da rentabilidade do tipo ações small caps
    [Tags]    informe    acoessmallcaps    medio
    Login.Acessar o HUB    ${EMAIL}
    Commons.Acessar o PLCota
    Commons.Iniciar cadastro manual
