*** Settings ***
Documentation      Essa automação valida marcação de inconsistências em fundos enviados no Encerramento - ANBIMA - FIDC
...
[Test02]Validar marcação de inconsistências em fundos enviados no Encerramento - ANBIMA - FIDC
    [Tags]    inconsistencia
    Acessar o HUB    ${EMAIL}
    ...
    Alterar acesso para administrador
    Validar inconsistencia no encerramento    Evidencia_Encerramento_FIDC