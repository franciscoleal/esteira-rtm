*** Settings ***
Documentation      Essa automação valida retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo ETF][Classe e Subclasse]
...
[Test69] Validar retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo ETF][Classe e Subclasse]
    ...
    Validar reanalise Encerramento    Evidencia_Retorno_Inconsistencia_4X_ETF    Aguardando análise anbima