*** Settings ***
Documentation      Essa automação valida retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo FIDC][Classe e Subclasse]
...
[Test66] Validar retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo FIDC][Classe e Subclasse]
    ...
    Validar reanalise Encerramento    Evidencia_Retorno_Inconsistencia_4X_FIDC    Aguardando análise anbima