*** Settings ***
Documentation      Essa automação valida retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo FIP][Classe e Subclasse]
...
[Test68] Validar retorno de inconsistência apontada 4x em campos diferentes pela Anbima [Fundo FIP][Classe e Subclasse]
    ...
    Validar reanalise Encerramento    Evidencia_Retorno_Inconsistencia_4X_FIP    Aguardando análise anbima