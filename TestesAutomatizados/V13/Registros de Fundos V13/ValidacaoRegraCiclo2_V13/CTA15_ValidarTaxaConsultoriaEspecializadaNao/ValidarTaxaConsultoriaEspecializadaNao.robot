*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa consultoria especializada = NÃO Perfil: "Desabilitado"
...
*** Test Cases ***
[Test15] Validar preenchimento dos campos de taxa consultoria especializada = NÃO Perfil: "Desabilitado"
    Acessar o HUB    ${EMAIL}
