*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Gestão = NÃO Perfil: Desabilitado
...
*** Test Cases ***
[Test13] Validar preenchimento dos campos de taxa Gestão = NÃO Perfil: Desabilitado
    Acessar o HUB    ${EMAIL}
    ...
    Preencher as taxas de consultoria especializada da classe V13
