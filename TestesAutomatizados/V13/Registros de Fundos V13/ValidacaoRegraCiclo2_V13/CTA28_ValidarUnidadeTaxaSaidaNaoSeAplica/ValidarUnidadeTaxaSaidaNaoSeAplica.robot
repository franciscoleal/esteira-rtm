*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Entrada e Saída "Unidade da taxa de saída" = Não se aplica
...
[Test28] Validar preenchimento dos campos de taxa Entrada e Saída "Unidade da taxa de saída" = Não se aplica
    Acessar o HUB    ${EMAIL}
    ...
    Validar campo taxa saida Nao Se Aplica    Evidencia_Taxa_saida_Nao_Se_Aplica