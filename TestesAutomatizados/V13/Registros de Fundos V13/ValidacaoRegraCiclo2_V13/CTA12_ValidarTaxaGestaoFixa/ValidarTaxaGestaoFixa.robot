*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Gestão = SIM Perfil: "FIXA"
...
[Test12] Validar preenchimento dos campos de taxa Gestão = SIM Perfil: "FIXA"
    Acessar o HUB    ${EMAIL}
