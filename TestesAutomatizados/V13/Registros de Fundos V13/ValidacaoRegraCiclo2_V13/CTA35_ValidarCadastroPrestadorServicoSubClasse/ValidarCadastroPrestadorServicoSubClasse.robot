*** Settings ***
Documentation      Essa automação valida cadastro de prestador de serviço (um por papel)"SubClasse"
...
[Test35] Validar cadastro de prestador de serviço (um por papel)"SubClasse"
    Acessar o HUB    ${EMAIL}
    ...
    Clicar na opção fundos    Solicitações
    Filtrar por CNPJ V13       ${CNPJ_VALIDO}
    Validar cadastro de um prestador de servico da Subclasse    Evidencia_Cadastro_Prestador_Servico_SubClasse