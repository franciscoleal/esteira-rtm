*** Settings ***
Documentation      Essa automação valida Obrigatoriedade de campos (campos preenchidos)
...
*** Test Cases ***
[Test06] Validar Obrigatoriedade de campos (campos preenchidos)
    Acessar o HUB    ${EMAIL}
    ...
    Clicar na opção fundos    Solicitações
    Filtrar por CNPJ V13       ${CNPJ_VALIDO}
    Acessar solicitacao    #depois voltar
    Validar obrigatoriedade de campos V13