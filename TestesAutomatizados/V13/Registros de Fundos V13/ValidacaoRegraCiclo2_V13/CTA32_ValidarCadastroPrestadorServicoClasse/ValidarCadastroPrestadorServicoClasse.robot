*** Settings ***
Documentation      Essa automação valida cadastro de prestador de serviço (um por papel)"Classe"
...
[Test32] Validar cadastro de prestador de serviço (um por papel)"Classe"
    Acessar o HUB    ${EMAIL}
    ...
    Clicar na opção fundos    Solicitações
    Filtrar por CNPJ V13       ${CNPJ_VALIDO}
    Validar cadastro de prestador de servico Classe    Evidencia_Cadastro_Prestador_Servico_Classe