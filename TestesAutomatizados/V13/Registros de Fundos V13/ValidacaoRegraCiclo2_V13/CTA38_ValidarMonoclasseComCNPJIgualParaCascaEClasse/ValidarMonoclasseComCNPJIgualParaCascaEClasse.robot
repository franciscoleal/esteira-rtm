*** Settings ***
Documentation      Essa automação valida registro do fundo monoclasse com CNPJ igual para casca e classe (Acatar)
...
[Test38] Validar registro do fundo monoclasse com CNPJ igual para casca e classe (Acatar)
    Acessar o HUB    ${EMAIL}
    ...
    Clicar na opção fundos    Solicitações
    Filtrar por CNPJ V13       ${CNPJ_VALIDO}
    Validar cadastro de CNPJ igual para casca e classe    Evidencia_Cadastro_CNPJ_Igual_Casca_Classe