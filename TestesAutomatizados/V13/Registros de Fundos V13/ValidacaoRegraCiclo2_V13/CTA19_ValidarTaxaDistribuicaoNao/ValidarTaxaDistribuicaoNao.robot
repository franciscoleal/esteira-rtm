*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Distribuição = NÃO Perfil: "Desabilitado"
...
*** Test Cases ***
[Test19] Validar preenchimento dos campos de taxa Distribuição = NÃO Perfil: "Desabilitado"
    Acessar o HUB    ${EMAIL}
