*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Previdência RF Duração Alta Crédito Livre
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Alta Crédito Livre
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF previdencia V13    Renda fixa    Previdência    Previdência RF Duração Alta Crédito Livre    DURACAO_ALTA    CREDITO_LIVRE
    ...
    Validar fundo em analise    PrevidenciaRFDuracaoAltaCreditoLivre