*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FIDC Outros
...
[Registro de Fundo]Registrar fundo do tipo FIDC Outros
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo FIDC Registro V13    FIDC    FIDC    Outros    vazia    vazia
    ...
    Validar fundo em analise    FIDCOutros
