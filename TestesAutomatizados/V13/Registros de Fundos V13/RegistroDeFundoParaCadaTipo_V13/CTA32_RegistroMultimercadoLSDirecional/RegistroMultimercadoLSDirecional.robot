*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Multimercados L/S - Direcional
...
[Registro de Fundo]Registrar fundo do tipo Multimercados LS Direcional
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Registro Multimercado V13     Multimercado    Multimercado    Multimercados L/S Direcional    Estrategias    Ls_Direcional
    ...
    Validar fundo em analise    MultimercadosLSDirecional