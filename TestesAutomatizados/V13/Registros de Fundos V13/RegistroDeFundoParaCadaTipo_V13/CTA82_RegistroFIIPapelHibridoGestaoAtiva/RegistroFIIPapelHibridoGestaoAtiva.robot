*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Papel Híbrido Gestão Ativa
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Papel Híbrido Gestão Ativa
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo FII V13    FII    FII    Papel Híbridos Gestão Ativa    vazia    vazia
    ...
    Validar fundo em analise    FIIPapelHibridoGestaoAtiva