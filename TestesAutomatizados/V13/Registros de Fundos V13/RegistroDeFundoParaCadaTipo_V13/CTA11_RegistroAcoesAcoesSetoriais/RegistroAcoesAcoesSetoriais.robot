*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Fundos de Ações Setoriais
...
[Registro de Fundo]Registrar fundo do tipo Fundos de Ações Setoriais
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Acao setorial V13    Ações    Ações    Ações Setoriais    ATIVOS    SETORIAIS
    ...
    Validar fundo em analise    AcoesAcoesSetoriais
