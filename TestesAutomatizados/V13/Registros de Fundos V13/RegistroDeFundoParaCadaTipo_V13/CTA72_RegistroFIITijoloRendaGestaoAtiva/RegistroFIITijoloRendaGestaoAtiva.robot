*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Tijolo Renda Gestão Ativa
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Tijolo Renda Gestão Ativa
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo Reg FII V13    FII    FII    Tijolo Renda Gestão Ativa    vazia    vazia
    ...
    Validar fundo em analise    FIITijoloRendaGestaoAtiva