*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Multimercados Juros Moedas
...
[Registro de Fundo]Registrar fundo do tipo Multimercados Juros Moedas
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Registro Multimercado V13    Multimercado    Multimercado    Multimercados Juros Moedas    Estrategias    Juros_Moedas
    ...
    Validar fundo em analise    MultimercadosJurosMoedas