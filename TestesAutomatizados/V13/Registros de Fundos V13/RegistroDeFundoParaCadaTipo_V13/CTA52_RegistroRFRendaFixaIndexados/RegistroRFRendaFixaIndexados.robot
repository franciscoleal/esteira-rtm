*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Indexados
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Indexados
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF Divida Externa V13    Renda fixa    Renda Fixa    Renda Fixa Indexados    INDEXADOS    INDICES
    ...
    Validar fundo em analise    RFIndexados