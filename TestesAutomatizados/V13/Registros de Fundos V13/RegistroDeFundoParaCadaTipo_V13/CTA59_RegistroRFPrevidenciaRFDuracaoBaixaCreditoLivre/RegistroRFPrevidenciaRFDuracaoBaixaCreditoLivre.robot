*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Previdência RF Duração Baixa Crédito Livre
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Baixa Crédito Livre
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF previdencia V13    Renda fixa    Previdência    Previdência RF Duração Baixa Crédito Livre    DURACAO_BAIXA    CREDITO_LIVRE
    ...
    Validar fundo em analise    PrevidenciaRFDuracaoBaixaCreditoLivre