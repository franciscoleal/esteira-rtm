*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Cambial
...
[Registro de Fundo]Registrar fundo do tipo Cambial
    Acessar o HUB    ${EMAIL}
    Validar perfil    Administrador
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    FIF Cambial    FIF    Monoclasse
    ...
    Validar fundo em analise    Cambial
