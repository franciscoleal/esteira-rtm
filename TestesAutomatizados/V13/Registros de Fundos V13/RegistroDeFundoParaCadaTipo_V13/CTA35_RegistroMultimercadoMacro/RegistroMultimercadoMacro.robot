*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Multimercados Macro
...
[Registro de Fundo]Registrar fundo do tipo Multimercados Macro
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Registro Multimercado macro exterior V13     Multimercado    Multimercado    Multimercados Macro    ESTRATEGIAS    MACRO
    ...
    Validar fundo em analise    MultimercadosMacro