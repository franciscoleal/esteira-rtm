*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Papel CRI Gestão Definida
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Papel CRI Gestão Definida
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo FII V13    FII    FII    Papel CRI Gestão Definida    vazia    vazia
    ...
    Validar fundo em analise    FIIPapelCRIGestaoDefinida