*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Papel Fundos Gestão Definida
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Papel Fundos Gestão Definida
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo FII V13    FII    FII    Papel Fundos Gestão Definida    vazia    vazia
    ...
    Validar fundo em analise    FIIPapelFundosGestaoDefinida