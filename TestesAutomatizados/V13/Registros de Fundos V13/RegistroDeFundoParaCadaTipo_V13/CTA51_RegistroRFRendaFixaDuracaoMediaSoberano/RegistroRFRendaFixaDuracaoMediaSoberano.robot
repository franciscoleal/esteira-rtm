*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Duração Média Soberano
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Média Soberano
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF Divida Externa V13    Renda fixa    Renda Fixa    Renda Fixa Duração Média Soberano    DURACAO_MEDIA    SOBERANO
    ...
    Validar fundo em analise    RFDuracaoMediaSoberano