*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Tijolo Desenvolvimento Gestão Ativa
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Tijolo Desenvolvimento Gestão Ativa
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo Reg FII V13    FII    FII    Tijolo Desenvolvimento Gestão Ativa    vazia    vazia
