*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Duração Média Crédito Livre
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Média Crédito Livre
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF Divida Externa V13    Renda fixa    Renda Fixa    Renda Fixa Duração Média Crédito Livre    Duracao_Media    Credito_Livre
    ...
    Validar fundo em analise    RFDuracaoMediaCreditoLivre