*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Fundos de Ações Valor/Crescimento
...
[Registro de Fundo]Registrar fundo do tipo Fundos de Ações Valor Crescimento
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos V13    Ações   Ações   Ações Valor Crescimento   ATIVOS   VALOR_CRESCIMENTO
    ...
    Validar fundo em analise    AcoesAcoesValorCrescimento
