*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Multimercados Trading
...
[Registro de Fundo]Registrar fundo do tipo Multimercados Trading
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Registro Multimercado V13     Multimercado    Multimercado    Multimercados Trading    Estrategias    Trading
    ...
    Validar fundo em analise    MultimercadosTrading