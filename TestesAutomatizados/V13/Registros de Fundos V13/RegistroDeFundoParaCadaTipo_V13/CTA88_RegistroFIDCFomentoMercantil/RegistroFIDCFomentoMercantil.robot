*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FIDC Fomento Mercantil 
...
[Registro de Fundo]Registrar fundo do tipo FIDC Fomento Mercantil 
    Acessar o HUB    ${EMAIL}
    Validar perfil    Administrador
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    FIDC Fomento Mercantil    FIDC    Monoclasse
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos Registro FIDC V13
    Concluir o fundo casca
    Preencher os dados cadastrais da classe fidc
    Preencher perfil da classe com argumentos completo FIDC Registro V13    FIDC    FIDC    Fomento Mercantil    vazia    vazia
    ...
    Validar fundo em analise    FIDCFomentoMercantil 
