*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Tijolo Híbrido Gestão Definida
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Tijolo Híbrido Gestão Definida
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo Reg FII V13    FII    FII    Tijolo Híbrido Gestão Definida    vazia    vazia
    ...
    Validar fundo em analise    FIITijoloHibridoGestaoDefinida