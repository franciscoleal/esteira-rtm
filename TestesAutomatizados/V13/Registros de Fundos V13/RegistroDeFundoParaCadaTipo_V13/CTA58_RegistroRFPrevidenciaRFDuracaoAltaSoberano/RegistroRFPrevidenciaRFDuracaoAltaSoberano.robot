*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Previdência RF Duração Alta Soberano
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Alta Soberano
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF previdencia V13    Renda fixa    Previdência    Previdência RF Duração Alta Soberano    DURACAO_ALTA    SOBERANO
    ...
    Validar fundo em analise    PrevidenciaRFDuracaoAltaSoberano