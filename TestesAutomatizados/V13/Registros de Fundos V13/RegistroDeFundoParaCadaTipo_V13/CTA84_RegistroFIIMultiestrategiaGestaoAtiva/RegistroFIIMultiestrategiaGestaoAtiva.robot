*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Multiestratégia Gestão Ativa
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Multiestratégia Gestão Ativa
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo FII V13    FII    FII    Multiestratégia Gestão Ativa    vazia    vazia
    ...
    Validar fundo em analise    FIIMultiestrategiaGestaoAtiva