...
[Registro de Fundo]Registrar fundo do tipo Acoes Investimento no Exterior
    ...
    Preencher os dados cadastrais    FIF Ações Investimento no Exterior    FIF    Monoclasse
    ...
    Preencher valor minimo e movimentacao FIF Ações    #alterado em 28.09.2024 campos resgate chumbado
