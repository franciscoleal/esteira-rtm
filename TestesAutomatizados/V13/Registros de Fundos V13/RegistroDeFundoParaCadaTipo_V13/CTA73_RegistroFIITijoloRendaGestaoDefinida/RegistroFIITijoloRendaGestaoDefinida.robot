*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Tijolo Renda Gestão Definida
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Tijolo Renda Gestão Definida
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos completo Reg FII V13    FII    FII    Tijolo Renda Gestão Definida    vazia    vazia
    ...
    Validar fundo em analise    FIITijoloRendaGestaoDefinida