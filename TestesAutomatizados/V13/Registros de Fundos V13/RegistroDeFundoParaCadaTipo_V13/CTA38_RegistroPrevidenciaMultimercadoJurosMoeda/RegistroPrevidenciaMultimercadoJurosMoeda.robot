...
[Registro de Fundo]Registrar fundo do tipo Previdencia Multimercados Juros e Moeda
    ...
    Preencher os dados cadastrais    FIF Previdencia Multimercado Juros e Moeda    FIF    Monoclasse
    ...
    Preencher perfil da classe com argumentos previdencia multimercado Livre V13    Multimercado    Previdência    Previdência Multimercados Juros Moedas    Multimercados    Juros_Moedas
