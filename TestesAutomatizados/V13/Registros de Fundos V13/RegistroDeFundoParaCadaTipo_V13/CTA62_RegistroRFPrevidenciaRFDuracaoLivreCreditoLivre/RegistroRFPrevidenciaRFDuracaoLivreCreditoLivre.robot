*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Previdência RF Duração Livre Crédito Livre
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Livre Crédito Livre
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos RF previdencia V13    Renda fixa    Previdência    Previdência RF Duração Livre Crédito Livre    DURACAO_LIVRE    CREDITO_LIVRE
    ...
    Validar fundo em analise    PrevidenciaRFDuracaoLivreCreditoLivre