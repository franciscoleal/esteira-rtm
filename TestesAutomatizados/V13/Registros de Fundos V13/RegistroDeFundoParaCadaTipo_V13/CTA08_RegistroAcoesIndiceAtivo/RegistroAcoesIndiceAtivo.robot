*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Acoes Indice Ativo
...
[Registro de Fundo]Registrar fundo do tipo Acoes Indice Ativo
    Acessar o HUB    ${EMAIL}
    Validar perfil    Administrador
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    FIF Ações Indice Ativo    FIF    Monoclasse
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe    Teste BDR Nível 1 Mercado de Acesso IE
    Preencher perfil da classe com argumentos V13    Ações    Ações    Ações Índice Ativo    Ativos    Indice_Ativo
    ...
    Validar fundo em analise    AcoesIndiceAtivo
