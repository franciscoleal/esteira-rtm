*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Off-Shore Renda Mista
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo Off-Shore Renda Mista
    Acessar o HUB    ${EMAIL}
    ...
    Preencher perfil da classe com argumentos Offshore V13    Offshore    Offshore    Offshore Renda Mista    vazia    vazia
