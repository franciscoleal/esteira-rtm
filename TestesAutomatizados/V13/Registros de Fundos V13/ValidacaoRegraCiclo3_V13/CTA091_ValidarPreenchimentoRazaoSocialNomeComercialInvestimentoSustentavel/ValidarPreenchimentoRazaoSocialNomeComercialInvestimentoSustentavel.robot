...
[Test095] Validar Preenchimento razão social ok, nome comercial ok (REFERENCIADO/Sufixo)
    ...
    Preencher os dados cadastrais da classe de renda fixa    teste CRED PRIV REFERENCIADO FC IE Investimento Sustentavel    teste CRED PRIV REFERENCIADO FC IE Investimento Sustentavel
    ...
    Validar preenchimento razaoSocial e nomeComercial Investimento Sustentavel