...
[Alteração Validação regras][Test32]Validar a alteração de uma fundo FIF para um fundo estruturado FIP
    [Tags]    test32
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe FIP Estruturado
