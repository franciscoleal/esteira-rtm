...
[Alteração Validação regras][Test19] Validar a tentativa de alteração do tipo do fundo ETF para outro tipo de fundo
    [Tags]    test19
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe ETF
