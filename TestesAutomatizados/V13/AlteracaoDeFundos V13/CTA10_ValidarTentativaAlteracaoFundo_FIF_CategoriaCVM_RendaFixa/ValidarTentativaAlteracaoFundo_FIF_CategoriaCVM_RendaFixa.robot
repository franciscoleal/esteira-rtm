...
[Alteração Validação regras][Test10] Validar a tentativa de alteração de uma fundo do tipo FIF e categoria CVM Renda Fixa
    [Tags]    test10
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe Renda Fixa
