...
[Alteração Validação regras][Test17] Validar a tentativa de alteração do tipo do fundo FIP para outro tipo de fundo
    [Tags]    test17
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe FIP
