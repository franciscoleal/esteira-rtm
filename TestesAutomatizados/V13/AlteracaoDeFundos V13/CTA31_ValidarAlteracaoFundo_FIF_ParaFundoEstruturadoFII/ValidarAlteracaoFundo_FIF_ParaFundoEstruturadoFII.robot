...
[Alteração Validação regras][Test31] Validar a alteração de um fundo FIF para um fundo estruturado FII
    [Tags]    test31
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe FII Estruturado
