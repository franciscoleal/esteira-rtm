...
[Alteração Validação regras][Test12] Validar a tentativa de alteração de uma fundo do tipo FIF e categoria CVM Previdência
    [Tags]    test12
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe Previdencia
