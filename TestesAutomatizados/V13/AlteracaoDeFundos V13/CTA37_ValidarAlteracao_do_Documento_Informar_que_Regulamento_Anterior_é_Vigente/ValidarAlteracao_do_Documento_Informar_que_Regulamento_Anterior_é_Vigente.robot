...
[Alteração Validação regras][Test37] Validar a alteração do mesmo documento e informar que o regulamento anterior é vigente
    [Tags]    test37
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Documentos em Fundo Casca FIDC
