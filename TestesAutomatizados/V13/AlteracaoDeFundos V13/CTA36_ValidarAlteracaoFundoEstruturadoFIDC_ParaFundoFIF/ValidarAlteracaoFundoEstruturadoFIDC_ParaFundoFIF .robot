...
[Alteração Validação regras][Test36]Validar a alteração de um fundo estruturado FIDC para um fundo FIF
    [Tags]    test36
    Acessar o HUB    ${EMAIL}
    ...
    Alterar campo Categoria CVM em Perfil da classe FIF
