*** Settings ***
Documentation      Essa automação valida encerramento de um fundo OFFSHORE
...
[Test19] Validar encerramento de um fundo OFFSHORE
    Acessar o HUB    ${EMAIL}
    ...
    Filtrar Offshore registrados    Ativo
    Alterar status para encerramento
    Alterar o acesso para autorregulador
    Clicar na opção fundos V13
    Filtrar Offshore registrados Autorregulador    Aguardando análise anbima
