*** Settings ***
Documentation      Essa automação valida que seja possível upload de arquivo no tamanho até 10Mb
...
[Test36] Validar que seja possível upload de arquivo no tamanho até 10Mb
