*** Settings ***
Documentation      Essa automação valida que seja possível as seguintes formatos de arquivos no encerramento (pdf)
...
[Test32] Validar que seja possível as seguintes formatos de arquivos no encerramento (pdf)
    ...
    Validar arquivo pdf    Evidencia_Arquivo_PDF