*** Settings ***
Documentation      Essa automação valida que seja possível as seguintes formatos de arquivos no encerramento (json)
...
[Test34] Validar que seja possível as seguintes formatos de arquivos no encerramento (json)
    ...
    Alterar status para encerramento Json
    Alterar o perfil    Autorregulador    ANBIMA    1
    ...
    Validar arquivo json    Evidencia_Arquivo_json