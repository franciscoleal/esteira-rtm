*** Settings ***
Documentation      Essa automação valida o cancelamento de um encerramento de uma Classe já preenchido e salvo no hub
...
[Test30] Validar o cancelamento de um encerramento de uma Classe já preenchido e salvo no hub
    ...
    Cancelar encerramento    Evidencia_Cancelar_Encerramento