*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Gestão = SIM Perfil: "Escalonada"
...
*** Test Cases ***
[Test11] Validar preenchimento dos campos de taxa Gestão = SIM Perfil: "Escalonada"
