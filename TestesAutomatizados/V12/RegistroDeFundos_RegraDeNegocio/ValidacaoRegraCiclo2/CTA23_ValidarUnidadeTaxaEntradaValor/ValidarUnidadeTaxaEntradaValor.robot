*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Entrada e Saída "Unidade de taxa de entrada" = Valor
...
[Test23] Validar preenchimento dos campos de taxa Entrada e Saída "Unidade de taxa de entrada" = Valor
    ...
    Preencher as taxas de entrada e saida da subclasse Valor
    ...
    Validar campo taxa entrada Valor    Evidencia_Taxa_Entrada_Valor
