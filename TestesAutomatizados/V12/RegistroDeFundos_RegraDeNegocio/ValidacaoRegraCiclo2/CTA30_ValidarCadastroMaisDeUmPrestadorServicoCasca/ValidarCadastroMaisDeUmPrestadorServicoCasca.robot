*** Settings ***
Documentation      Essa automação valida Cadastro de mais um prestador de serviço para os papéis definidos como únicos "Fundo Casca"
...
[Test30] Validar Cadastro de mais um prestador de serviço para os papéis definidos como únicos "Fundo Casca"
    ...
    Preencher mais de um prestador    Evidencia_Cadastro_Mais_Prestadores_Servico_Casca
    ...
    Validar cadastro de mais de um prestador de servico    Evidencia_Cadastro_Prestador_Servico