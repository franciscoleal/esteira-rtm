*** Settings ***
Documentation      Essa automação valida cadastro de prestador de serviço (um por papel)"Fundo Casca"
...
[Test29] Validar cadastro de prestador de serviço (um por papel)"Fundo Casca"
    ...
    Validar cadastro de prestador de servico    Evidencia_Cadastro_Prestador_Servico