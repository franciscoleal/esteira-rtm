*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Administrativa = NÃO Perfil: Desabilitado
...
*** Test Cases ***
[Test10] Validar preenchimento dos campos de taxa Administrativa = NÃO Perfil: Desabilitado
