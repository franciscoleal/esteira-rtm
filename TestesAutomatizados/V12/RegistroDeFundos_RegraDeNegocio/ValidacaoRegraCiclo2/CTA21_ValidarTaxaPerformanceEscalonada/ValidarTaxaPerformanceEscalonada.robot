*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Performance = SIM Perfil: "Escalonada"
...
*** Test Cases ***
[Test21] Validar preenchimento dos campos de taxa Performance = SIM Perfil: "Escalonada"
