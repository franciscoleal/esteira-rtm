*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Performance = SIM Perfil: "Fixa"
...
[Test20] Validar preenchimento dos campos de taxa Performance = SIM Perfil: "Fixa"
    ...
    Validar campo taxa performance Fixa    Evidencia_Taxa_Performance_Fixa