*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Administrativa = SIM Perfil: "Escalonada"
...
*** Test Cases ***
[Test08] Validar preenchimento dos campos de taxa Administrativa = SIM Perfil: "Escalonada"
    ...
    Preencher as taxas de administracao da classe Escalonada    Evidencia_Taxa_Administracao_Sim_Escalonada
    Preencher as taxas de gestao da classe Escalonada    Evidencia_Taxa_Gestao_Sim_Escalonada
    Preencher as taxas de custodia da classe
    Preencher as taxas de distribuicao da classe
    Preencher as taxas de performance da subclasse Escalonada    Evidencia_Taxa_Performance_Sim_Escalonada
