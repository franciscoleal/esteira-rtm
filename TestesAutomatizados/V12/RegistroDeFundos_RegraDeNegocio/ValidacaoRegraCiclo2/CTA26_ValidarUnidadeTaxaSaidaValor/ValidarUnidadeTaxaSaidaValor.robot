*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa Entrada e Saída "Unidade da taxa de saída" = Valor
...
[Test26] Validar preenchimento dos campos de taxa Entrada e Saída "Unidade da taxa de saída" = Valor
    ...
    Validar campo taxa saida Valor    Evidencia_Taxa_saida_Valor
