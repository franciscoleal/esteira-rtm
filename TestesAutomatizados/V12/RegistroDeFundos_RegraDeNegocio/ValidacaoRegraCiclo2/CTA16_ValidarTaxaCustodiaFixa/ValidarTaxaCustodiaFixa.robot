*** Settings ***
Documentation      Essa automação valida preenchimento dos campos de taxa custódia = SIM Perfil: "Fixa"
...
[Test16] Validar preenchimento dos campos de taxa custódia = SIM Perfil: "Fixa"
    ...
    Validar campo taxa custodia Fixa    Evidencia_Taxa_Custodia_Fixa