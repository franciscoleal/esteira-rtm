...
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Alta Grau de Inv.
    ...
    Preencher perfil da classe com argumentos RF Previdencia    Renda fixa    Previdência    Previdência RF Duração Alta Grau Invest    DURACAO_ALTA    GRAU_INVESTIMENTO
