*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FII Papel CRI High Grade Gestão Ativa
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo FII Papel CRI High Grade Gestão Ativa
    ...
    Preencher perfil da classe com argumentos completo    FII    FII    Papel CRI High Grade Gestão Ativa    vazia    vazia
    # Preencher perfil da classe com argumentos FII    FII    FII    Papel CRI High Grade Gestão Ativa
    ...
    Validar fundo em analise    FIIPapelCRIHighGradeGestaoAtiva