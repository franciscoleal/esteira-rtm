*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Previdencia Balanceados > 30
...
[Registro de Fundo]Registrar fundo do tipo Previdencia Balanceados > 30
    Acessar o HUB    vimerson.miura@vericode.com.br
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    Previdencia Balanceados > 30    FIF
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe previdencia
    Preencher perfil da classe com argumentos previdencia    Ações    Previdência    Previdência Balanceados Acima 30    previdencia    balanceados_acima_30
    ...
    Validar fundo em analise    PrevidenciaBalanceadosMaiorQue30
