*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Duração Baixa Crédito Livre
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Baixa Crédito Livre
    ...
    Preencher perfil da classe com argumentos RF Renda Fixa    Renda fixa    Renda Fixa    Renda Fixa Duração Baixa Crédito Livre    Duracao_Baixa    Credito_Livre 
    ...
    Validar fundo em analise    RFDuracaoBaixaCreditoLivre