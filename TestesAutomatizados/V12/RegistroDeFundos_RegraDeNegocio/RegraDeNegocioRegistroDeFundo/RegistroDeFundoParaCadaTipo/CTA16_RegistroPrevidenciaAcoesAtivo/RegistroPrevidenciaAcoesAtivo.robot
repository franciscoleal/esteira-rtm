*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Previdencia Acoes Ativo
...
[Registro de Fundo]Registrar fundo do tipo Previdencia Acoes Ativo
    Acessar o HUB    vimerson.miura@vericode.com.br
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    Previdencia Acoes Ativo    FIF
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe previdencia
    Preencher perfil da classe com argumentos previdencia    Ações    Previdência    Previdência Ações Ativo    acoes_ativos    ativos
    ...
    Validar fundo em analise    PrevidenciaAcoesAtivo
