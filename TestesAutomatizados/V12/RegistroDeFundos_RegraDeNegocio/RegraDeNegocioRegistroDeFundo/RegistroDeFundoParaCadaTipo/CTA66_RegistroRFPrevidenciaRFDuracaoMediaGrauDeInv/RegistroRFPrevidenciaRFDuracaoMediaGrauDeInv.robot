...
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Média Grau de Inv
    ...
    Preencher perfil da classe com argumentos RF Previdencia    Renda fixa    Previdência    Previdência RF Duração Média Grau Invest    DURACAO_MEDIA    GRAU_INVESTIMENTO
