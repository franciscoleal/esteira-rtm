*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Multimercados Invest. No Exterior
...
[Registro de Fundo]Registrar fundo do tipo Multimercados Invest. No Exterior
    ...
    Preencher perfil da classe com argumentos Multimercados Investimento Exterior     Multimercado    Multimercado    Multimercados Investimento Exterior    Investimento_Exterior    Investimento_Exterior
