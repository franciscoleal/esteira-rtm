*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Duração Alta Grau de Invest.
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Alta Grau de Invest.
    ...
    Preencher os dados cadastrais da classe de renda fixa    teste CRED PRIV REFERENCIADO INVESTIMENTO NO EXTERIOR FC    teste CRED PRIV REFERENCIADO INVESTIMENTO NO EXTERIOR FC
    Preencher perfil da classe com argumentos RF Renda Fixa    Renda fixa    Renda Fixa    Renda Fixa Duração Alta Grau Invest    Duracao_Alta    Grau_Investimento 
    ...
    Validar fundo em analise    RFDuracaoAltaGrauInvest