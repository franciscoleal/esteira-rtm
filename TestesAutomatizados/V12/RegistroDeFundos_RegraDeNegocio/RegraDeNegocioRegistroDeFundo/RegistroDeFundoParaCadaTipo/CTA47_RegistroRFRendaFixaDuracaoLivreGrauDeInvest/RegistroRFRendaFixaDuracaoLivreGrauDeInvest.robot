*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Duração Livre Grau de Invest.
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Livre Grau de Invest.
    ...
    Preencher perfil da classe com argumentos RF Renda Fixa    Renda fixa    Renda Fixa    Renda Fixa Duração Livre Grau Invest    Duracao_Livre    Grau_Investimento
    ...
    Validar fundo em analise    RFDuracaoLivreGrauInvest.