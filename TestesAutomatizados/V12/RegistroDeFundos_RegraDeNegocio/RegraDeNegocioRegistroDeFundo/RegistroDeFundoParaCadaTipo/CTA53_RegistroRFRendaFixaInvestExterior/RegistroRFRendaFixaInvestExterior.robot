*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo RF Renda Fixa Invest. No Exterior
...
*** Test Cases ***
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Invest. No Exterior
    ...
    Preencher perfil da classe com argumentos RF Investimento Exterior    Renda fixa    Renda Fixa    Renda Fixa Investimento Exterior    Investimento_Exterior    Investimento_Exterior
    ...
    Validar fundo em analise    RFInvestExterior