...
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Indexados
    ...
    #Preencher perfil da classe com argumentos RF Previdencia    Renda fixa    Previdência    Previdência RF Indexados    RENDA_FIXA_INDEXADOS    INDICES
    Preencher perfil da classe com argumentos RF Previdencia Indexados    Renda fixa    Previdência    Previdência RF Indexados    RENDA_FIXA_INDEXADOS    INDICES
    ...
    Validar fundo em analise    PrevidenciaRFIndexados