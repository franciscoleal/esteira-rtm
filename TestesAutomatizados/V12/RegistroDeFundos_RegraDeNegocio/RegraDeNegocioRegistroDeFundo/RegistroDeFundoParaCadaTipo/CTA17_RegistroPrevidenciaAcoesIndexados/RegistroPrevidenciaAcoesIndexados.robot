...
[Registro de Fundo]Registrar fundo do tipo Previdencia Acoes Indexados
    ...
    Preencher os dados cadastrais    Previdencia Acoes Indexados    FIF
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe previdencia
    Preencher perfil da classe com argumentos previdencia    Ações    Previdência    Previdência Ações Indexados    acoes_Indexados    indices
