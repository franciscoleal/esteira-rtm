...
[Registro de Fundo]Registrar fundo do tipo Acoes Indice Ativo
    ...
    Preencher os dados cadastrais    FIF Ações Indice Ativo    FIF
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe acoes no exterior
    Preencher perfil da classe com argumentos no exterior    Ações    Ações    Ações Índice Ativo    Ativos    Indice_Ativo
