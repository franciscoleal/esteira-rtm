*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Fundos de Fechados de Ações
...
[Registro de Fundo]Registrar fundo do tipo Fundos de Fechados de Ações
    ...
    Preencher perfil da classe com argumentos Fechado de Ações    Ações    Ações    Ações Fechado de Ações    Especificos    Fechado de Ações
    ...
    Validar fundo em analise    AcoesFechadosAcoes
