...
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Baixa Grau de Inv
    ...
    Preencher perfil da classe com argumentos RF Previdencia    Renda fixa    Previdência    Previdência RF Duração Baixa Grau Invest    DURACAO_BAIXA    GRAU_INVESTIMENTO
