...
[Registro de Fundo]Registrar fundo do tipo RF Previdência RF Duração Livre Grau de Inv
    ...
    Preencher perfil da classe com argumentos RF Previdencia    Renda fixa    Previdência    Previdência RF Duração Livre Grau Invest    DURACAO_LIVRE    GRAU_INVESTIMENTO
