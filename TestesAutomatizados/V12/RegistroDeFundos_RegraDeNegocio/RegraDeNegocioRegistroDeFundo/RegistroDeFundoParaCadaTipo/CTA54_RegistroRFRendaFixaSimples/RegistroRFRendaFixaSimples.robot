...
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Simples
    ...
    Preencher os dados cadastrais da classe de renda fixa    teste REFERENCIADO CRED PRIV FC IE Simples    teste REFERENCIADO CRED PRIV FC IE Simples
    Preencher perfil da classe com argumentos RF Simples    Renda fixa    Renda Fixa    Renda Fixa Simples    RENDA_FIXA_SIMPLES    RENDA_FIXA_SIMPLES
