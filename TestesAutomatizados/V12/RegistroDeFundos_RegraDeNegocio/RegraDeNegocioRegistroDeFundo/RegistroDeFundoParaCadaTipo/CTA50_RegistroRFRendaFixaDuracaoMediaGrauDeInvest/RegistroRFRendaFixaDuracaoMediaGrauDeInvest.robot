...
[Registro de Fundo]Registrar fundo do tipo RF Renda Fixa Duração Média Grau de Invest
    ...
    Preencher perfil da classe com argumentos RF Divida Externa    Renda fixa    Renda Fixa    Renda Fixa Duração Média Grau Invest    Duracao_Media    Grau_Investimento
