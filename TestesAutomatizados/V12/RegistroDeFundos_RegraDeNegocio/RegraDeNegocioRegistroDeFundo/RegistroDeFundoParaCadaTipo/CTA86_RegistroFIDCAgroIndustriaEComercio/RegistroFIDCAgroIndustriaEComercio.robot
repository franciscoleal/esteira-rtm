*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo FIDC Agro, Indústria e Comércio
...
[Registro de Fundo]Registrar fundo do tipo FIDC Agro, Indústria e Comércio
    ...
    Preencher os dados cadastrais da classe de FIDC    Teste CP    Teste CP
    Preencher perfil da classe com argumentos completo    FIDC padronizado    FIDC    FIDC Agro Indústria Comércio    vazia    vazia
