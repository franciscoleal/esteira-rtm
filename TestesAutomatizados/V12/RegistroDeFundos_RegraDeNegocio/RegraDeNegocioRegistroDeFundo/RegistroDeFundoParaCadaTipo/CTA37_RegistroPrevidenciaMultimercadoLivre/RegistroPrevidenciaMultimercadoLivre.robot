...
[Registro de Fundo]Registrar fundo do tipo Previdencia Multimercados Livre
    ...
    Preencher os dados cadastrais    FIF Previdencia Multimercado Livre
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe previdencia multimercado
    Preencher perfil da classe com argumentos previdencia multimercado    Multimercado    Previdência    Previdência Multimercado Livre    Multimercados    Livre
