*** Settings ***
Documentation      Essa automação realiza um cadastro de um fundo do tipo Previdencia Balanceados ate 15
...
[Registro de Fundo]Registrar fundo do tipo Previdencia Balanceados ate 15
    Acessar o HUB    vimerson.miura@vericode.com.br
    Clicar na opção fundos    Solicitações
    Clicar em registro de fundos
    Preencher os dados cadastrais    Previdencia Balanceados ate 15    FIF
    Preencher perfil do fundo
    Preencher os prestadores
    Preencher os documentos
    Concluir o fundo casca
    Preencher os dados cadastrais da classe previdencia
    Preencher perfil da classe com argumentos previdencia    Ações    Previdência    Previdência Balanceados Até 15    previdencia    balanceados_ate_15
    ...
    Validar fundo em analise    PrevidenciaBalanceadosAte15
