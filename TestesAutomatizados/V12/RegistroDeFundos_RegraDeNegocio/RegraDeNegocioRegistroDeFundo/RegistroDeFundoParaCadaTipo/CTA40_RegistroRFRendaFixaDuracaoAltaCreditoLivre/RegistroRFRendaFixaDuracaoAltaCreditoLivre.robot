...
[Registro de Fundo]Registrar fundo do tipo RF Duracao Livre Credito Livre
    ...
    Preencher os dados cadastrais da classe de renda fixa    teste REFERENCIADO    teste REFERENCIADO
    Preencher perfil da classe com argumentos RF Duracao Alta Credito Livre    Renda fixa    Renda Fixa    Renda Fixa Duração Alta Crédito Livre    Duracao_Alta    Credito_Livre 
    ...
    Validar fundo em analise    RFDuracaoAltaCreditoLivre